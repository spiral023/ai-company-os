...
- 2026-08-04 · [[2026-08-04-anthropic-docs-claude-code-best-practices]] · meinung — Anthropic benennt „Agent Teams“ offiziell als Feature (Team-Lead, geteilte Aufgaben, Messaging) — deckt sich exakt mit dem hier bereits belegten Lead/Teammate-Modell; ergänzt die Fan-out-Technik (Dateiliste generieren, per Skript iterieren, `claude -p` pro Datei, erst an wenigen testen).
- 2026-02-01 · [[2026-02-01-anthropic-docs-claude-code-best-practices]] · meinung — Offizielle Doku empfiehlt Subagents explizit für Recherche, damit die Exploration den Hauptkontext nicht flutet.
