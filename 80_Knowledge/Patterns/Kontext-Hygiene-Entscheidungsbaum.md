...
- 2026-07-27 · [[2026-07-27-cerebras-gpt-5-6-modellwahl-und-reasoning]] · meinung — Liefert die Gegenrichtung mit Zahlen: Cached Input kostet 10 % des Normalpreises (per OpenAI-Preisseite bestätigt) bei ~30 Minuten TTL, weshalb eine warme Session ökonomisch günstiger ist als eine neue pro Aufgabe. Ergänzt Codex-Automations im 20-Minuten-Takt als Technik zum Cache-Warmhalten.
- 2026-08-04 · [[2026-08-04-anthropic-docs-claude-code-best-practices]] · meinung — Offizielle Doku ergänzt feinere Werkzeuge seit Februar: `/rewind` mit gezieltem „Summarize from/up to this message“, `/btw` für Zwischenfragen in einem verwerfbaren Overlay ohne Kontextbindung, und customisierbare Compaction per CLAUDE.md-Anweisung.
- 2026-02-01 · [[2026-02-01-anthropic-docs-claude-code-best-practices]] · meinung — Offizielle Doku benennt vier Fehlermuster (Kitchen-Sink-Session, endlose Korrekturen, überladene CLAUDE.md, Infinite Exploration) mit je einem Fix — bereits einzeln belegt, hier erstmals offiziell als geschlossene Liste bestätigt.
- 2026-02-14 · [[2026-02-14-minty-mastering-claude-code]] · meinung — Ergänzt Checkpoints nach jedem einzelnen Edit statt großer Batches, damit ein Absturz mitten in der Arbeit nicht den Fortschrittsüberblick kostet.

## Spannungen & offene Fragen

- 2026-01-10-eyad-khrais nennt eine Degradierungsschwelle von 20-40 % eines 200k-Token-Fensters (grob 40.000-80.000 Tokens) — deutlich niedriger als die hier dokumentierte 300k-400k-Heuristik. Beide Zahlen sind unbelegte Erfahrungswerte aus Sekundärquellen; die Diskrepanz wird nicht glattgezogen, da unklar ist, ob sie sich auf vergleichbare Fenstergrößen und Modelle bezieht.
- Seit 2026-07-27 belegte Gegenkraft zur Aufräum-Empfehlung: Prompt-Caching macht das Verharren in einer warmen Session ökonomisch attraktiv (Cached Input 10 % des Preises, TTL ~30 min), während dieses Pattern aus Qualitätsgründen zu frühem `/clear` und `/compact` rät. Die Cerebras-Quelle behauptet zudem, Codex-Kompaktion sei gut genug für Sessions über hunderte Millionen Tokens — das widerspricht der hier mehrfach belegten Erfahrung, dass Kompaktion verlustbehaftet bleibt, und ist selbst unbelegt. Trade-off bewusst offen: Kostenoptimum und Kontextqualität zeigen hier in verschiedene Richtungen, die Grenze müsste am eigenen Workload gemessen werden.
