...
titel: "Agent Skills vs. Rules vs. Commands"
autor: "Alice Alexandra Moore (@tempoimmaterial)"
datum: 2026-01-21
erfasst: 2026-08-04
typ: tweet
quelle: vibedeck
...
> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/agent-skills-vs-rules.md`). Primärquelle: https://x.com/tempoimmaterial/status/2014054104658526645

![Agent Skills vs Rules Header](medien/2026-01-21-tempoimmaterial-agent-skills-vs-rules/header.jpg)
...
![Progressive Disclosure Diagram](medien/2026-01-21-tempoimmaterial-agent-skills-vs-rules/progressive-disclosure.png)
...
![Decision Tree Flowchart](medien/2026-01-21-tempoimmaterial-agent-skills-vs-rules/decision-tree.png)
...
![Inheritance vs Composition](medien/2026-01-21-tempoimmaterial-agent-skills-vs-rules/inheritance-vs-composition.jpg)
...
![Subagents Diagram](medien/2026-01-21-tempoimmaterial-agent-skills-vs-rules/subagents.png)
