...
titel: "How I Use Claude Code (Full Guide)"
...
# How I Use Claude Code (Full Guide)

> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/claude-code-spec-first.md`). Primärquelle: https://x.com/ashpreetbedi/status/2011220028453241218

![How I Use Claude Code Header](medien/2026-01-14-ashpreetbedi-claude-code-spec-first/header.png)
