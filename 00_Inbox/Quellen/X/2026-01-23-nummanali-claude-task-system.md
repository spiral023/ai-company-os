...
titel: "Das neue Claude Code Task System: Der Praktische Guide"
...
# Das neue Claude Code Task System: Der Praktische Guide

> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/claude-task-system.md`). Primärquelle: https://x.com/nummanali/status/2014684862985175205

![Claude Code Task System Header](medien/2026-01-23-nummanali-claude-task-system/header.jpg)
...
![Visual Progress Tracking](medien/2026-01-23-nummanali-claude-task-system/visual-progress.jpg)
...
![TaskCreate JSON](medien/2026-01-23-nummanali-claude-task-system/task-create.jpg)

### 2. TaskUpdate
Modifiziert einen existierenden Task (Status, Owner, Abhängigkeiten).

![TaskUpdate JSON](medien/2026-01-23-nummanali-claude-task-system/task-update.jpg)
...
![Visual Dependencies](medien/2026-01-23-nummanali-claude-task-system/visual-dependencies.jpg)
...
![Wedding Planning Dependencies](medien/2026-01-23-nummanali-claude-task-system/wedding-planning.jpg)
