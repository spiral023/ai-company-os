...
titel: "Claude Code /insights: Der Befehl, der deinen KI-Workflow spiegelt"
autor: "Tom Crawshaw"
datum: 2026-02-09
erfasst: 2026-08-04
typ: tweet
...
# Claude Code /insights: Der Befehl, der deinen KI-Workflow spiegelt

> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/claude-code-insights-guide.md`). Primärquelle: https://x.com/tomcrawshaw01/status/2020866308230009189

![Claude Code Insights Header](medien/2026-02-09-tom-crawshaw-claude-code-insights-guide/header.jpg)
