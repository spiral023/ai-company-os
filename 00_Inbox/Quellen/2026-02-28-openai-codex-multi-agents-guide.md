...
titel: "OpenAI Codex Multi-Agents: Parallelle Agenten-Workflows"
autor: "OpenAI"
datum: 2026-02-28
erfasst: 2026-08-04
typ: url
...
# OpenAI Codex Multi-Agents: Parallelle Agenten-Workflows

> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/codex-multi-agents-guide.md`). Primärquelle: https://developers.openai.com/codex/multi-agent/
