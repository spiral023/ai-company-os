...
titel: "Planning with files: Der 'Cheat Code' für Claude Code"
autor: "Anthony Riera"
datum: 2026-02-02
erfasst: 2026-08-04
typ: tweet
...
> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/planning-with-files-skill.md`). Primärquelle: https://x.com/anthonyriera/status/2018221220160827828

![Planning with files GitHub Preview](medien/2026-02-02-anthony-riera-planning-with-files-skill/header.jpg)
