...
titel: "Use Claude Code in VS Code"
...
> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/claude-code-vs-code.md`). Primärquelle: https://code.claude.com/docs/en/vs-code
