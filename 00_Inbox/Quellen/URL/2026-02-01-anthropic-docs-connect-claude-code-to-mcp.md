...
titel: "Connect Claude Code to tools via MCP"
...
> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/connect-claude-code-to-mcp.md`). Primärquelle: https://code.claude.com/docs/en/mcp
