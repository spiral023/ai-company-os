...
titel: "Custom Subagents erstellen"
...
status: neu
beschreibung: "Erstelle spezialisierte Subagents in Claude Code mit eigenem Prompt, Tools und Permissions."
...
> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/create-custom-subagents.md`). Primärquelle: https://code.claude.com/docs/en/sub-agents
