...
titel: "Gemini Image Generation Guide"
autor: "Google AI"
datum: 2026-02-01
erfasst: 2026-08-04
typ: url
...
> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/gemini-image-generation.md`). Primärquelle: https://ai.google.dev/gemini-api/docs/image-generation
