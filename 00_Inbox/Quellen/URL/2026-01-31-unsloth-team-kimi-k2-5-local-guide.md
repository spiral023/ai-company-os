...
titel: "Kimi K2.5: Lokale Ausführung & Guide"
autor: "Unsloth Team"
datum: 2026-01-31
erfasst: 2026-08-04
typ: url
...
> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/kimi-k2.5-local-guide.md`). Primärquelle: https://unsloth.ai/docs/models/kimi-k2.5

![Unsloth Logo](medien/2026-01-31-unsloth-team-kimi-k2-5-local-guide/header.jpg)
