...
titel: "Der Boris Tane Workflow: Claude Code effizient nutzen"
autor: "Boris Tane"
datum: 2026-02-10
erfasst: 2026-08-04
typ: url
...
status: neu
beschreibung: "Lerne den disziplinierten Workflow von Boris Tane kennen: Trennung von Planung und Implementierung durch Annotationen in Markdown-Dateien."
...
# Der Boris Tane Workflow: Claude Code effizient nutzen

> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/boris-tane-claude-code-workflow.md`). Primärquelle: https://boristane.com/blog/how-i-use-claude-code/
