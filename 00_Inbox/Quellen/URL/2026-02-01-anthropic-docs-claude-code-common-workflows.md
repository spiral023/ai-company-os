...
titel: "Claude Code Common Workflows"
...
> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/claude-code-common-workflows.md`). Primärquelle: https://code.claude.com/docs/en/common-workflows
