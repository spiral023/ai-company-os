...
titel: "Claude Code in GitLab CI/CD"
...
source_notiz: 80_Knowledge/Sources/2026-02-01-anthropic-docs-claude-code-gitlab-ci.md
beschreibung: ">-"
...
> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/claude-code-gitlab-ci.md`). Primärquelle: https://code.claude.com/docs/en/gitlab-ci-cd
