...
titel: "Der komplette Guide zum Erstellen von Agent Skills"
...
# Der komplette Guide zum Erstellen von Agent Skills

> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/guide-building-agent-skills.md`). Primärquelle: https://x.com/rohit4verse/status/2021622526112358663

![Building Agent Skills Header](medien/2026-02-11-rohit4verse-guide-building-agent-skills/header.jpg)
