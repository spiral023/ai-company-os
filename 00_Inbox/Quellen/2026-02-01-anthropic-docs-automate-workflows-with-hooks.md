...
titel: "Automate workflows with hooks"
...
> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/automate-workflows-with-hooks.md`). Primärquelle: https://code.claude.com/docs/en/hooks-guide
