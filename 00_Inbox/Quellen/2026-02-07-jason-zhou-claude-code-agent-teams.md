...
titel: "Claude Code Agent Teams: Der Guide zur Installation und Nutzung"
autor: "Jason Zhou"
datum: 2026-02-07
erfasst: 2026-08-04
typ: tweet
...
status: neu
medien: "8 lokal"
beschreibung: "Ein tiefer Einblick in das neue Agenten-Modell von Claude Code: Wie Agent Teams funktionieren, wie man sie installiert und warum sie herkömmliche Sub-Agenten übertreffen."
...
# Claude Code Agent Teams: Der Guide zur Installation und Nutzung

> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/claude-code-agent-teams.md`). Primärquelle: https://x.com/jasonzhou1993/status/2020086991740891526

![Claude Code Agent Teams Header](medien/2026-02-07-jason-zhou-claude-code-agent-teams/header.jpg)
...
![Setup Agent Teams](medien/2026-02-07-jason-zhou-claude-code-agent-teams/setup.jpg)
...
![Teams vs Subagents](medien/2026-02-07-jason-zhou-claude-code-agent-teams/teams-vs-subagents.jpg)
...
![TeamCreate Tool](medien/2026-02-07-jason-zhou-claude-code-agent-teams/tool-teamcreate.jpg)
...
![TaskCreate Tool](medien/2026-02-07-jason-zhou-claude-code-agent-teams/tool-taskcreate.jpg)
...
![Task Tool](medien/2026-02-07-jason-zhou-claude-code-agent-teams/tool-task.jpg)

### Tool 4: TaskUpdate
Teammitglieder nutzen dieses Tool, um Aufgaben zu beanspruchen ("claim") oder den Status zu aktualisieren.
![TaskUpdate Tool](medien/2026-02-07-jason-zhou-claude-code-agent-teams/tool-taskupdate.jpg)
...
![SendMessage Tool](medien/2026-02-07-jason-zhou-claude-code-agent-teams/tool-sendmessage.jpg)
