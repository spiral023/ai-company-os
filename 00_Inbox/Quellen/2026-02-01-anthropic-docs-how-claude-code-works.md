...
status: neu
beschreibung: "Verstehe den agentischen Loop, die eingebauten Tools und wie Claude Code mit deinem Projekt interagiert."
...
> Sekundärquelle: aus vibedeck übernommene deutsche Aufarbeitung (`src/content/knowledge/how-claude-code-works.md`). Primärquelle: https://code.claude.com/docs/en/how-claude-code-works
